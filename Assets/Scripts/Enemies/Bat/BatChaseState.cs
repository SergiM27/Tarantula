...
public class BatChaseState : BatPatrolState {

    public float initspeed=2.5f;
    public float rangeVisionBat = 5.5f;
    ...
    private void FixedUpdate()
    {
        ...
        {
            GetComponent<BatPatrolState>().enabled = true;
            enabled = false;
        }
    }
