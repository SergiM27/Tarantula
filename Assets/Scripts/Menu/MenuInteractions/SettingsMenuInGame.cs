...
public class SettingsMenuInGame : MonoBehaviour {
    ...
    public void SettingButton()
    {
        if (isSettingsOpen == false)
        {
            ...
            isSettingsOpen = true;
            GameObject.Find("EventSystem1Final").GetComponent<EventSystem>().SetSelectedGameObject(firstObjectMain, null);
        }
        else
        {
            ...
            GameObject.Find("EventSystem1Final").GetComponent<EventSystem>().SetSelectedGameObject(firstObjectSettings, null);
        }
        PauseMenu.Click_Sound();
    }
}
